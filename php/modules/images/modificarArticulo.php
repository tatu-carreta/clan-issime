<?php
	...
	$sql = modificarArticulo($_POST['idArticulo'],$_POST['nombre'], $nombreURL, $_POST['codigo'], $_POST['material'], $_POST['idCategoria'], $_POST['precioMayorista'], $_POST['precioMinorista'], $idImagen,  $_POST['estado']);
	if($sql)
	{
		echo $sql;
	}
