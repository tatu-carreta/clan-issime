...
--
-- Servidor: localhost
-- Tiempo de generación: 12-12-2013 a las 18:18:37
...
CREATE TABLE IF NOT EXISTS `persona` (
  ...
  `calle` varchar(300) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
...
(1, 'Administrador', '', '0000-00-00', '', 1, '', 0, NULL, NULL, 0, '', 'A');
...
INSERT INTO `usuario` (`idUsuario`, `nombreUsuario`, `claveUsuario`, `idPersona`, `idPerfil`, `cantidadIngresos`, `estado`) VALUES
(1, '97d5ef8e7053c11182882bede5ff2ab6', '4c7ef3b96f381dcbc98d1aa217880194', 1, 1, 0, 'A');
