...
--
-- Servidor: localhost
-- Tiempo de generación: 22-02-2014 a las 15:26:16
...
(1, 'Manhattan', '2013-12-03', NULL, 0, 'A');
...
--
-- Estructura de tabla para la tabla `denim`
--

CREATE TABLE IF NOT EXISTS `denim` (
  `idDenim` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `imagen` (
  ...
  `idCorrelativa` int(11) DEFAULT NULL,
...
(1, '127.0.0.1', '/clan-issime/controller/controladorAdminModel.php', '910c76cbc45541d9c4cfe9db1f78708275bd5d36900408f3742d1126', '2014-02-22 12:21:09');
...
CREATE TABLE IF NOT EXISTS `mayorista` (
  ...
  `calleFiscal` varchar(300) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `numeroFiscal` int(11) NOT NULL,
  `pisoFiscal` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `departamentoFiscal` varchar(10) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `idCiudadFiscal` int(11) NOT NULL,
  `codPostalFiscal` int(11) NOT NULL,
  `telefonoFiscal` varchar(50) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  `estado` char(1) CHARACTER SET utf8 COLLATE utf8_spanish_ci NOT NULL,
  PRIMARY KEY (`idMayorista`),
  KEY `FK_mayorista_persona` (`idPersona`),
  KEY `FK_mayorista_condicion_iva` (`idCondicionIva`),
  KEY `FK_mayorista_ciudad` (`idCiudadFiscal`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=2 ;
...
INSERT INTO `mayorista` (`idMayorista`, `idPersona`, `cuit`, `razonSocial`, `idCondicionIva`, `nombreFantasia`, `calleFiscal`, `numeroFiscal`, `pisoFiscal`, `departamentoFiscal`, `idCiudadFiscal`, `codPostalFiscal`, `telefonoFiscal`, `estado`) VALUES
(1, 3, 99999, 'MAXI', 5, 'SERL:', '22', 33, '1', '', 147, 1111, '627722', 'A');
...
--
-- Estructura de tabla para la tabla `noche`
--

CREATE TABLE IF NOT EXISTS `noche` (
  `idNoche` int(11) NOT NULL AUTO_INCREMENT,
  `imagen` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`idNoche`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
(2, 'Empleado', '', NULL, '-1', 1, NULL, NULL, NULL, NULL, NULL, NULL, 'A'),
(3, 'maxi', 'maxi', '1992-01-28', 'max.angletti@gmail.com', 5, '11', 22, '2', 'A', 222, '111', 'A'),
(4, 'mino', 'mino', '1992-01-01', 'mino@mino.com', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'A'),
(5, 'nuevo', 'nuevo', NULL, 'nuevo@nuevo.com', NULL, NULL, NULL, NULL, NULL, NULL, '9999', 'B');
...
--
-- Estructura de tabla para la tabla `texto_locales`
--

CREATE TABLE IF NOT EXISTS `texto_locales` (
...
CREATE TABLE IF NOT EXISTS `urbano` (
  `idUrbano` int(11) NOT NULL AUTO_INCREMENT,
  `imagen` varchar(200) COLLATE utf8_unicode_ci NOT NULL,
...
(1, '9e06b97915f259ff17a5a44dc9dffb13293acebf4f6094e9a8a4cfaa', 'c1b898e64080d2c5034e905f886a63fb63256088c9658de954294d90', 1, 1, 44, 'A', '53095d5fde24e35fdbd74fe2af6645c93bf909b9859dd24e93a5e9df', NULL, NULL),
(4, '38c692c6fed3033197c688460712a71cbb96eb20ca47c5985de33061', 'afa9a7d2cdcc81595c5552918f0614b7e400dd4eb3b01a79df424dae', 2, 4, 6, 'A', '910c76cbc45541d9c4cfe9db1f78708275bd5d36900408f3742d1126', NULL, NULL),
(5, '1692afa7baf618d9ba30cf3f0e9af64f7e8f466eba116d752339e0ab', 'c05c303ed085e0703560d61e006334fb93b388465976ae3bf58b5071', 3, 2, 3, 'A', '6358f5f621b8559d220d50b26d0ba1eeb0a98d79d300ea8f3feb1f74', '2014-02-22 11:48:22', NULL),
(6, '34f544761f30c19ab63a38a136b42186b00241f2481a2a2ae6835021', 'ecf2597326d9a48b62ab7c9b9bfbf7f96096db90651457bc6d3a7d52', 4, 3, 2, 'A', 'b95032ced5a824b01060a31d6ab58c3dd9fff0ea78f036e3109c5e89', '2014-02-22 12:01:19', NULL),
(7, '5a832fa8aecc2502d75d466f81a7e4fcc1fbe9e5a594f88a9cfc4c01', '5a832fa8aecc2502d75d466f81a7e4fcc1fbe9e5a594f88a9cfc4c01', 5, 3, 1, 'B', 'cd60c8537c82e6e4926316f6736de512319acb75d93cff7d90fd2602', '2014-02-22 12:21:00', '2014-02-22 12:22:02');
...
(1, 4, '127.0.0.1', '2014-02-18 23:07:02'),
(2, 1, '127.0.0.1', '2014-02-18 23:07:15'),
(3, 5, '127.0.0.1', '2014-02-22 11:48:22'),
(4, 5, '127.0.0.1', '2014-02-22 11:48:24'),
(5, 6, '127.0.0.1', '2014-02-22 12:01:19'),
(6, 6, '127.0.0.1', '2014-02-22 12:01:20'),
(7, 5, '127.0.0.1', '2014-02-22 12:04:56'),
(8, 1, '127.0.0.1', '2014-02-22 12:17:18'),
(9, 4, '127.0.0.1', '2014-02-22 12:17:35'),
(10, 4, '127.0.0.1', '2014-02-22 12:18:48'),
(11, 1, '127.0.0.1', '2014-02-22 12:20:14'),
(12, 4, '127.0.0.1', '2014-02-22 12:20:28'),
(13, 1, '127.0.0.1', '2014-02-22 12:23:08'),
(14, 1, '127.0.0.1', '2014-02-22 12:24:15'),
(15, 4, '127.0.0.1', '2014-02-22 12:25:28');
...
ALTER TABLE `mayorista`
  ADD CONSTRAINT `FK_mayorista_ciudad` FOREIGN KEY (`idCiudadFiscal`) REFERENCES `ciudad` (`idCiudad`),
